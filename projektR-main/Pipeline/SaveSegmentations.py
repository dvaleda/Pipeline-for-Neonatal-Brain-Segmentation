...
model_path = Path('/home/tea/TecaGit/ProjektR/Pipeline/Pipeline/results/baseline_results1672398133/best_metric_model_epoch_1.pth')
...
with torch.no_grad():
    print("save_loader len:" + str(len(save_loader)))
    print(save_loader)
