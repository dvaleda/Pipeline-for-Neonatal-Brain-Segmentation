...
class TrainCollector(Collector):
    ...
    def create_train_val_test_ids(self):
        ...
        val_ids = id_list_shuffle[train_stop:train_stop+val_stop]
        test_ids = id_list_shuffle[train_stop+val_stop:num_samples]
    ...
    def get_loaders(self, pixdim, roi_size, batch_size, slicing_mode = None, selection_mode=None):
        ...
        if self.mode == 'transfer':
            ...
            val_ds = Dataset(val_dict, transform=val_transform)
            val_loader = DataLoader(val_ds, batch_size=batch_size, shuffle=True) # PROMJENJENO IZ Size u size !!!!!!!!!!!!!
