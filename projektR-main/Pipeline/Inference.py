...
model_path = Path('/home/tea/TecaGit/ProjektR/Pipeline/Pipeline/results/prvi_od_50_epoha/best_metric_model_epoch_33.pth')
...
if inferencelogger.mode == 'transfer':
    train_loader, test_loader = testcollector.get_loaders(pixdim, roi_size, batch_size)
else:
    test_loader = testcollector.get_loaders(pixdim, roi_size, batch_size)
...
step = 0
with torch.no_grad():
    print("test_loader len:" + str(len(test_loader)))
    print(test_loader)
