...
while True:
    absolute_path = input("Unesite apsolutni put do direktorija gdje su izvorni podaci (npr. /media/tea/DATA/rel3_dhcp_anat_pipeline):")
    if os.path.isdir(absolute_path):
        print("Koristimo put " + absolute_path + " u daljnjem procesu.")
        raw_data_dir = Path(absolute_path)
        break
    else:
        print("Direktorij ne postoji, pokusajte ponovno.")
